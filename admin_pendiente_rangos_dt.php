<?php
  ...
  'host' => $hostname
	...
	";
	//MODELADO PARA QUE SE MUESTREN FACTURAS PENDIENTES DE PREVENTAS SIN LIMITE DE TIEMPO
	$extraWhere = "fac.id_sucursal='$id_sucursal' AND fac.anulada=0 AND fac.finalizada=0";
	$columns = array(
