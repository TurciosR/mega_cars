                    ...
                    <div class="ibox-content">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-2">
                                <div class="form-group has-info">
                                    ...
                                    <input type="text" class="form-control" id="num_plac" name="num_plac" value="">
                      ...
                      -->
                        ...
                        <div class="form-group col-md-8">
                                <div id="a">
                                    <label>Diagnostico Preliminar/Trabajo a realiza</label>
                                    <input type="text" id="diagnostico" name="diagnostico" style="width:100% !important"
                                        class="form-control usage" placeholder="Ingrese Una Descripción del Problema"
                                        style="border-radius:0px">
                                </div>
                        </div>
