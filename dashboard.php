			...
			<div class="wrapper wrapper-content">
					...
					<div class="col-lg-6">
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								...
								<span class="label label-info pull-right">Recórd por cliente</span>
							</div>
							<div class="ibox-content" style="margin-top: 1.8px;">
								<div>
									<table class="table">
										...
										//$fecha_actual = date("Y-m-d");
										$sql="SELECT cliente.nombre, factura.total,numero_ref FROM factura JOIN cliente ON cliente.id_cliente=factura.id_cliente WHERE numero_ref!=0 AND finalizada!=1 AND factura.id_sucursal=1 LIMIT 5";
				...
				<?php } ?>
					<div class="col-md-6">
						<div class="ibox float-e-margins">
							<div class="ibox-title">
								<h5>Listado de productos a expirar en los proximos 3 meses</h5>
								<div class="ibox-tools">
									<a class="collapse-link">
							...
							<div class="ibox-content">
								<table class="table table-hover no-margins">
									...
									<tbody>
										...
										$sql=_query("SELECT producto.descripcion,lote.cantidad,lote.vencimiento FROM lote JOIN producto WHERE lote.id_producto=producto.id_producto AND lote.estado='VIGENTE' AND vencimiento BETWEEN '$hoy' AND '$man'");
