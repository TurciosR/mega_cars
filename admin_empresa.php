...
<div class="wrapper wrapper-content  animated fadeInRight">
                    ...
                    <form name="formulario" id="formulario">
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group has-info single-line">
                                    ...
                                    <input type="text" placeholder="Digite Nombre" class="form-control" id="nombre"
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    ...
                                    <input type="text" placeholder="Razón Social" class="form-control dis" id="razon"
                                        name="razon" value="<?php echo $razon;?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    ...
                                    <input type="text" placeholder="Dirección" class="form-control" id="n_sucursal"
                                        name="n_sucursal" value="<?php echo $n_sucursal;?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    ...
                                    <input type="text" placeholder="Teléfono 1" class="form-control dis tel"
                                        id="telefono1" name="telefono1" value="<?php echo $telefono1;?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    <label>Teléfono 2</label>
                                    <input type="text" placeholder="Teléfono 2" class="form-control dis tel"
                                        id="telefono2" name="telefono2" value="<?php echo $telefono2;?>">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    <label>NIT</label>
                                    <input type="text" placeholder="NIT" class="form-control dis nit" id="nit"
                                        name="nit" value="<?php echo $nit;?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    <label>NRC</label>
                                    <input type="text" placeholder="NRC" class="form-control dis nrc" id="nrc"
                                        name="nrc" value="<?php echo $nrc;?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    <label>IVA</label>
                                    <input type="text" placeholder="IVA" class="form-control dis" id="iva" name="iva"
                                        value="<?php echo $iva;?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    <label>Giro</label>
                                    <input type="text" placeholder="Giro" class="form-control dis" id="giro" name="giro"
                                        value="<?php echo $giro;?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    ...
                                    <input type="text" placeholder="Monto inicial de retencion 1%"
                                        class="form-control dis" id="monto_retencion1" name="monto_retencion1"
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    ...
                                    <input type="text" placeholder="Monto inicial de retencion 10%"
                                        class="form-control dis" id="monto_retencion10" name="monto_retencion10"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group has-info single-line">
                                    ...
                                    <input type="text" placeholder="Monto inicial de percepción"
                                        class="form-control dis" id="monto_percepcion" name="monto_percepcion"
                                        value="<?php echo $monto_percepcion;?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group has-info">
                                    <img id="logo_view" name="logo_view" src="<?php echo $logo;?>"
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <input type="hidden" name="id_sucursale" id="id_sucursale"
                                    value="<?php echo $id_sucursal;?>">
	...
	function editar()
	{
		...
		$valido_n_sucu=_query("SELECT n_sucursal FROM sucursal WHERE id_sucursal='$n_sucursal' AND id_sucursal!='$id_sucursale'");
